...
const Tabs = class {
    ...
    render() {
        ...
        return (h("div", { class: this.getComponentClassNames() }, h("div", { class: "header", ref: (el) => this.headerEl = el }, h("div", { class: "scrollable", ref: (el) => this.scrollableEl = el }, h("div", { class: "indicator", ref: (el) => this.indicatorEl = el, style: { display: "none" /* will be displayed during animation */ } }), h("ul", { ref: (el) => this.listEl = el, role: "tablist" }, this.tabsItemElsSorted.map((tabsItemEl) => h("li", null, h("button", { ref: (el) => this.tabsItemsWithButtonEl.set(tabsItemEl, el), class: this.getTabsItemButtonClassNames(tabsItemEl), onClick: () => this.select(tabsItemEl), title: tabsItemEl.label, disabled: tabsItemEl.disabled, role: "tab", "aria-expanded": (tabsItemEl === this.selectedTabsItemEl).toString(), "aria-selected": (tabsItemEl === this.selectedTabsItemEl).toString(), onFocus: (e) => {
                e.preventDefault(); // Play animation instead of "hard jump" to the focussed tab
                this.scrollUntilVisibleIfHidden(tabsItemEl);
            } }, h("sdx-icon", { iconName: tabsItemEl.iconName }), " ", tabsItemEl.label)))), h("div", { class: "line" })), h("sdx-arrow", { ref: (el) => this.leftArrowEl = el, class: "left", direction: "left", hideBackground: !this.showLeftArrow, hideArrow: !this.showLeftArrow, onClick: () => this.scroll("left") }), h("sdx-arrow", { ref: (el) => this.rightArrowEl = el, class: "right", direction: "right", hideBackground: !this.showRightArrow, hideArrow: !this.showRightArrow, onClick: () => this.scroll("right"), animationBeginCallback: () => {
