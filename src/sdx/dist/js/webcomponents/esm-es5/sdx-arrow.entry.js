...
var Arrow = /** @class */ (function () {
    ...
    Arrow.prototype.getComponentClassNames = function () {
        var _a;
        return _a = {
                component: true
            },
    ...
    Arrow.prototype.render = function () {
        return (h("sdx-animation", { animationName: this.hideBackground ? "fade-out" : "fade-in", animationBeginCallback: this.animationBeginCallback }, h("div", { class: this.getComponentClassNames() }, h("div", { class: "arrow-container" }, h("sdx-animation", { animationName: this.hideArrow ? "scale-out" : "scale-in" }, h("div", { class: "arrow" }))))));
    };
    return Arrow;
}());
Arrow.style = arrowCss;
export { Arrow as sdx_arrow };
