...
var MenuFlyoutListItem = /** @class */ (function () {
    ...
    MenuFlyoutListItem.prototype.onClick = function (e) {
        if (this.disabled) {
            e.stopPropagation();
        }
    };
    MenuFlyoutListItem.prototype.componentWillLoad = function () {
        this.store = getStore(this);
        this.unsubscribe = mapStateToProps(this, this.store, [
            "directionState"
        ]);
    };
    MenuFlyoutListItem.prototype.componentDidLoad = function () {
        var _a;
        // Register arrow el
        (_a = this.store) === null || _a === void 0 ? void 0 : _a.dispatch({ type: "TOGGLE_ARROW_EL", arrowEl: this.arrowEl });
    };
    MenuFlyoutListItem.prototype.componentDidUnload = function () {
        var _a, _b;
        // Unregister arrow el
        (_a = this.store) === null || _a === void 0 ? void 0 : _a.dispatch({ type: "TOGGLE_ARROW_EL", arrowEl: this.arrowEl });
        (_b = this.unsubscribe) === null || _b === void 0 ? void 0 : _b.call(this);
    };
    MenuFlyoutListItem.prototype.getHostClassNames = function () {
    ...
    MenuFlyoutListItem.prototype.getLinkClassNames = function () {
        return {
            body: true,
            disabled: this.disabled
        };
    };
    MenuFlyoutListItem.prototype.render = function () {
        var _this = this;
        return (h(Host, { class: this.getHostClassNames() }, h("div", { class: "item" }, h("div", { class: "arrow", ref: function (el) { return _this.arrowEl = el; } }), h("a", { href: this.href, hreflang: this.hreflang, class: this.getLinkClassNames() }, h("slot", null)))));
    };
    Object.defineProperty(MenuFlyoutListItem.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    return MenuFlyoutListItem;
}());
