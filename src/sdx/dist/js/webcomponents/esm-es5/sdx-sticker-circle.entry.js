...
var StickerCircle = /** @class */ (function () {
     ...
     */
    StickerCircle.prototype.onWindowResizeThrottled = function () {
        var _this = this;
        if (this.resizeTimer) {
    ...
    StickerCircle.prototype.componentDidLoad = function () {
        this.resize();
    };
    StickerCircle.prototype.resize = function () {
    ...
    StickerCircle.prototype.getClassNames = function () {
        var _a;
        return _a = {
                sticker: true
            },
            _a[this.colorClass] = true,
            _a["bg-" + this.bgColorClass] = true,
            _a;
    };
    StickerCircle.prototype.getStyles = function () {
        var isScalingEnabled = this.contentWidth !== undefined;
        return {
            sticker: {
                width: this.size + "px",
                height: this.size + "px",
    ...
    StickerCircle.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("div", { class: "wrapper", ref: function (el) { return _this.wrapperEl = el; } }, h("div", { class: this.getClassNames(), style: this.getStyles().sticker, ref: function (el) { return _this.stickerEl = el; } }, h("div", { class: "inner", style: this.getStyles().inner, "aria-hidden": "true" }, h("slot", { name: "text" }))), h("div", { class: "slot", style: this.getStyles().slot }, h("slot", null))), h("span", { class: "sr-only" }, this.srHint)));
    };
    return StickerCircle;
}());
