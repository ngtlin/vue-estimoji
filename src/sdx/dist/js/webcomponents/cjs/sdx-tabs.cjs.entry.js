...
const immutabilityHelpers = require('./immutability-helpers-3e707722.js');
...
const tabsReducer = (state = {}, action) => {
    switch (action.type) {
        case "TOGGLE_TABS_ITEM_EL":
            const tabsItemEls = immutabilityHelpers.toggle(state.tabsItemEls, action.tabsItemEl);
            return Object.assign(Object.assign({}, state), { tabsItemEls, tabsItemElsSorted: [...tabsItemEls].sort(webcomponentHelpers.sortByAppearanceInDomTree) });
...
const Tabs = class {
    ...
    componentWillLoad() {
        this.setInvokeChangeCallback();
        this.store = storeHelpers.createAndInstallStore(this, tabsReducer, this.getInitialState());
    ...
    render() {
        ...
        return (index.h("div", { class: this.getComponentClassNames() }, index.h("div", { class: "header", ref: (el) => this.headerEl = el }, index.h("div", { class: "scrollable", ref: (el) => this.scrollableEl = el }, index.h("div", { class: "indicator", ref: (el) => this.indicatorEl = el, style: { display: "none" /* will be displayed during animation */ } }), index.h("ul", { ref: (el) => this.listEl = el, role: "tablist" }, this.tabsItemElsSorted.map((tabsItemEl) => index.h("li", null, index.h("button", { ref: (el) => this.tabsItemsWithButtonEl.set(tabsItemEl, el), class: this.getTabsItemButtonClassNames(tabsItemEl), onClick: () => this.select(tabsItemEl), title: tabsItemEl.label, disabled: tabsItemEl.disabled, role: "tab", "aria-expanded": (tabsItemEl === this.selectedTabsItemEl).toString(), "aria-selected": (tabsItemEl === this.selectedTabsItemEl).toString(), onFocus: (e) => {
                e.preventDefault(); // Play animation instead of "hard jump" to the focussed tab
                this.scrollUntilVisibleIfHidden(tabsItemEl);
            } }, index.h("sdx-icon", { iconName: tabsItemEl.iconName }), " ", tabsItemEl.label)))), index.h("div", { class: "line" })), index.h("sdx-arrow", { ref: (el) => this.leftArrowEl = el, class: "left", direction: "left", hideBackground: !this.showLeftArrow, hideArrow: !this.showLeftArrow, onClick: () => this.scroll("left") }), index.h("sdx-arrow", { ref: (el) => this.rightArrowEl = el, class: "right", direction: "right", hideBackground: !this.showRightArrow, hideArrow: !this.showRightArrow, onClick: () => this.scroll("right"), animationBeginCallback: () => {
                // Initially scroll to selected tab (if hidden)
                if (this.initiallyShowRightArrow) {
                    this.scrollUntilVisibleIfHidden(this.selectedTabsItemEl);
                }
                this.initiallyShowRightArrow = false;
            } })), index.h("div", { class: "body" }, index.h("slot", null))));
    }
