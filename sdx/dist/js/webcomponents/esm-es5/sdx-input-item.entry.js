...
var InputItem = /** @class */ (function () {
    ...
    InputItem.prototype.valueChanged = function () {
        this.updateHiddenFormInputEl();
    };
    InputItem.prototype.nameChanged = function () {
        this.updateHiddenFormInputEl();
    };
    InputItem.prototype.nameStateChanged = function () {
        this.updateHiddenFormInputEl();
    };
    InputItem.prototype.checkedChanged = function () {
        var _a, _b, _c, _d, _e;
    ...
    InputItem.prototype.selectedInputItemElsChanged = function () {
        var _a;
    ...
    InputItem.prototype.changeCallbackChanged = function () {
        this.setInvokeChangeCallback();
    };
    InputItem.prototype.onClick = function (e) {
        // Prevent checkbox from getting focussed if needed
        if (this.disableFocus) {
            e.preventDefault();
        }
    };
    InputItem.prototype.handleKeyDown = function (e) {
        var _a, _b;
        var key = e.key;
    ...
    InputItem.prototype.componentWillLoad = function () {
        var _a, _b;
    ...
    InputItem.prototype.componentDidUnload = function () {
        var _a, _b;
    ...
    InputItem.prototype.getInputType = function () {
        return this.typeState || this.type;
    };
    InputItem.prototype.check = function () {
    ...
    InputItem.prototype.initHiddenFormInputEl = function () {
    ...
    InputItem.prototype.updateHiddenFormInputEl = function () {
    ...
    InputItem.prototype.setInvokeChangeCallback = function () {
        this.invokeChangeCallback = parseFunction(this.changeCallback);
    };
    InputItem.prototype.getName = function () {
        return this.nameState || this.name;
    };
    InputItem.prototype.description = function () {
        return (h("span", { id: "description", class: "description" }, h("slot", { name: "description" })));
    };
    InputItem.prototype.getHostClassNames = function () {
        return {
            "input-container": this.themeState === "container"
        };
    };
    InputItem.prototype.getComponentClassNames = function () {
        var _f;
        return _f = {
                component: true,
    ...
    Object.defineProperty(InputItem.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(InputItem, "watchers", {
        get: function () {
            return {
                "value": ["valueChanged"],
                "name": ["nameChanged"],
