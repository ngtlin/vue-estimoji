...
var Price = /** @class */ (function () {
    ...
    Price.prototype.isInteger = function () {
        return this.amount === Math.floor(this.amount);
    };
    Price.prototype.getClassNames = function () {
        var _a;
        return _a = {
                integer: this.isInteger()
            },
            _a["text-" + (this.size > 6 ? "d" : "h") + ((this.size > 6 ? 9 : 6) - this.size + 1)] = true,
            _a;
    };
    Price.prototype.render = function () {
        return [
            h("span", { class: this.getClassNames(), "aria-hidden": "true" }, this.getFormattedAmount(), h("span", { class: "period" }, this.period)),
