...
const Ribbon = class {
    ...
    render() {
        return (index.h(index.Host, { class: `${this.design} ${this.position} ${this.size}` }, index.h("div", { class: "wrapper" }, index.h("div", { class: "slot" }, index.h("slot", null)), index.h("div", { class: "ribbon-container" }, this.design === "loop"
            ? (index.h("div", { class: "content" }, this.label))
            : (this.label)))));
    }
};
Ribbon.style = ribbonCss;

exports.sdx_ribbon = Ribbon;
