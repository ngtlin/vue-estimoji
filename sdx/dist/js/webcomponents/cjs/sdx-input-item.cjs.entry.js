...
const isSymbol = require('./isSymbol-52737210.js');
...
var symbolProto = isSymbol.Symbol ? isSymbol.Symbol.prototype : undefined,
...
const InputItem = class {
    ...
    description() {
        return (index.h("span", { id: "description", class: "description" }, index.h("slot", { name: "description" })));
    }
    getHostClassNames() {
        return {
    ...
    render() {
        return (index.h(index.Host, { class: this.getHostClassNames() }, index.h("div", { class: this.getComponentClassNames() }, this.groupLabel && index.h("div", { class: "sr-only", id: "groupLabel" }, this.groupLabel), index.h("input", { id: this.uniqueId, type: this.getInputType(), checked: this.checked, disabled: this.disabled, "aria-describedby": "groupLabel description validationMessage", ref: (el) => this.inputEl = el, tabindex: this.disableFocus ? -1 : undefined, onClick: () => this.check(), value: undefined }), index.h("label", { htmlFor: this.uniqueId, style: this.labelStyle }, index.h("slot", null), " ", this.required && index.h("span", null, "*"), this.themeState === "container" &&
            this.description(), this.themeState === "container" && this.iconName &&
            index.h("div", null, index.h("sdx-icon", { class: "icon-placeholder", "icon-name": this.iconName, size: this.iconSize, "aria-hidden": "true" }), index.h("sdx-icon", { class: "icon", "icon-name": this.iconName, size: this.iconSize, "aria-hidden": "true" }))), this.themeState === "none" &&
            this.description(), this.validationMessage &&
            index.h("sdx-validation-message", { id: "validationMessage", validationMessage: this.validationMessage }))));
    }
...
exports.sdx_input_item = InputItem;
