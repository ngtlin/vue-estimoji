...
const StickerCircle = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "wrapper", ref: (el) => this.wrapperEl = el }, index.h("div", { class: this.getClassNames(), style: this.getStyles().sticker, ref: (el) => this.stickerEl = el }, index.h("div", { class: "inner", style: this.getStyles().inner, "aria-hidden": "true" }, index.h("slot", { name: "text" }))), index.h("div", { class: "slot", style: this.getStyles().slot }, index.h("slot", null))), index.h("span", { class: "sr-only" }, this.srHint)));
    }
};
StickerCircle.style = stickerCircleCss;

exports.sdx_sticker_circle = StickerCircle;
