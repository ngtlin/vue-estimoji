...
const ProgressFull = class {
    ...
    updateStepElement(elIndex, animation) {
        ...
        anime_es.anime.remove(this.stepEls[elIndex]);
    ...
    setInvokeStepChangeCallback() {
        this.invokeStepChangeCallback = webcomponentHelpers.parseFunction(this.stepChangeCallback);
    }
    render() {
        return [
            index.h("div", { class: "info-content" }, this.stepsCount, " ", this.stepsLabel),
            index.h("slot", null),
            index.h("sdx-arrow", { class: "left", direction: "left", hideArrow: true, onClick: () => this.scrollLeft() }),
            index.h("sdx-arrow", { class: "right", direction: "right", hideArrow: true, onClick: () => this.scrollRight() })
        ];
    }
...
exports.sdx_progress_full = ProgressFull;
