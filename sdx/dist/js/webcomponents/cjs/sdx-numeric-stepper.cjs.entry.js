...
const NumericStepper = class {
    ...
    render() {
        return (index.h("div", { class: this.getComponentClassNames() }, this.label &&
            index.h("label", { class: "label", onClick: () => this.focusInputField(), "aria-hidden": "true" }, this.label), index.h("div", { class: "wrapper" }, index.h("sdx-input", { srHint: this.srHintValue, type: "number", ref: (el) => this.sdxInputEl = el, inputCallback: (value) => this.inputElValue = value, blurCallback: () => this.setValueState(this.inputElValue), inputStyle: this.getInputStyle(), value: this.inputElValue, min: this.min, max: this.max, disabled: this.disabled, valid: this.valid, validationMessage: this.validationMessage }), index.h("sdx-button", { theme: "transparent", class: this.getButtonClassNames("left"), iconName: "icon-minus", iconSize: 3, disabled: this.decreaseDisabled || this.disabled, onClick: () => this.decrease(), tabindex: "-1", "aria-hidden": "true", valid: this.valid && this.validationMessage !== "" }), index.h("sdx-button", { theme: "transparent", class: this.getButtonClassNames("right"), iconName: "icon-plus", iconSize: 3, disabled: this.increaseDisabled || this.disabled, onClick: () => this.increase(), tabindex: "-1", "aria-hidden": "true", valid: this.valid && this.validationMessage !== "" }))));
    }
...
exports.sdx_numeric_stepper = NumericStepper;
